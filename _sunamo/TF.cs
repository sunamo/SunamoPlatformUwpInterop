...
//internal class TF
//{
//    internal static string ReadAllTextSync(string p)
//    {
//        return File.ReadAllText(p);
//    }

//    internal static List<byte> ReadAllBytesSync(string p)
//    {
...
//    internal static List<string> WriteAllLinesSync(string p, List<string> c)
//    {
//        return File.ReadAllLines(p).ToList();
//    }
